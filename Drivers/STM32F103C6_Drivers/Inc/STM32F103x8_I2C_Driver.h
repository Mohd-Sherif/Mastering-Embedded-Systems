...
typedef struct{
	...
	/**
	 * @stretchMode
	 * Specifies Enable or Disable clock stretching in slave mode only.
	...
	/**
	 * @generalCall
	 * Specifies Enable or Disable General Call.
	...
	/**
	 * @masterMode
	 * Specifies I2C Master mode SM mode or FM mode.
	...
	/**
	 * @mode
	 * Specifies I2C SMBUS mode or I2C mode.
	...
	/**
	 * @ACK_Control
	 * Enable ACK by Hardware or Disable ACK.
	 * This parameter must be set based on @ref I2C_ACK_CONTROL_DEFINE.
	 */
	uint32_t ACK_Control;

	/**
	 * @slaveAddress
	 * Slave address information from user.
	 */
	I2C_slave_address_t	slaveAddress;
